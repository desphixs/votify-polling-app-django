"""
Django settings for votify_project project.
...
SECRET_KEY = 'django-insecure-y^e0ch90im+%1-6@8^@!m1_j9q$r@qo-fd=t8ev3wy#m-okpd@'
...
INSTALLED_APPS = [
    ...
    # -------------------------------------------------------------------------
    # REGISTERING OUR CUSTOM APP: 'polls'
    # -------------------------------------------------------------------------
    ...
    #
    # However, you just built a brand new recreational gaming lounge (our 'polls' app)
    ...
    #
    # By adding the string 'polls' to this list, we are telling Django's central 
    # settings: "Hey Django, please look inside the 'polls' folder we created, load 
...
ROOT_URLCONF = 'votify_project.urls'
...
WSGI_APPLICATION = 'votify_project.wsgi.application'
